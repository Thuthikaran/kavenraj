  ...
  return (
    <div className="max-w-4xl mx-auto my-5 px-4 py-6">
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto my-10">
        ...
        <div className="bg-white p-5 rounded-xl shadow-sm border-t-4 border-[#000080]">
          <h3 className="font-bold text-lg text-gray-800 mb-2">Flexible Verification</h3>
          <p className="text-gray-600">Bank statements and invoices accepted instead of traditional pay stubs.</p>
        </div>

        <div className="bg-white p-5 rounded-xl shadow-sm border-t-4 border-[#000080]">
          <h3 className="font-bold text-lg text-gray-800 mb-2">Fast Results</h3>
          <p className="text-gray-600">Same-day application submission once documents are received.</p>
        </div>
      </div>
