  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6">
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto my-10">
        ...
        <div className="bg-white p-5 rounded-xl shadow-sm border-t-4 border-[#000080]">
          <h3 className="font-bold text-lg text-gray-800 mb-2">Low Down Payment Options</h3>
          <p className="text-gray-600">Explore programs designed to make homeownership more affordable.</p>
        </div>
